document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    const getErrorMessage = function (field) {
      ...
      if (type === 'email' && field.value.trim() && !validators.email(field.value)) {
        return 'Please enter a valid email address.';
      }
      if (type === 'tel' && field.value.trim() && !validators.tel(field.value)) {
  ...
  animationStyle.textContent =
    ...
    '.fade-in.fade-in-visible{opacity:1;transform:translateY(0);}' +
    '@media(prefers-reduced-motion:reduce){.fade-in,.fade-in.fade-in-visible{transition:none;transform:none;opacity:1;}}';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ARTEECA משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4b0796b5-40af-4aa8-b5ea-7902d531f6c5',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4b0796b5-40af-4aa8-b5ea-7902d531f6c5';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4b0796b5-40af-4aa8-b5ea-7902d531f6c5';
